    ...
    <section className="text-gray-600 body-font">
      <div className="container flex flex-col items-center px-5 py-24 mx-auto md:flex-row">
        <div className="flex flex-col w-full pr-0 mb-6 text-center md:pr-10 md:mb-0 md:w-auto md:text-left">
          <h2 className="mb-1 text-xs font-medium tracking-widest text-emerald-500 title-font">
            Easily find the nearest CNG pump station
          </h2>
        ...
        <div className="flex items-center flex-shrink-0 mx-auto space-x-4 md:ml-auto md:mr-0">
          <a
            href="https://play.google.com/store/apps/details?id=com.gvcng.cngnavigator"
            target="_blank"
          >
